...
I am a final-year Computer Science student at Plaksha University and I am currently researching on interpretability and machine unlearning at [Precog Lab at IIIT Hyderabad](https://precog.iiit.ac.in/). My past research were based on Retrieval Augmentation Generation related RL problems and learning visual embeddings involving jigsaw puzzles in particular. I have also worked in the fields of Human-Centered Computing during an project invloving detecting human impairements using vision language models.

Topics of research that intrigue me include, but are not limited to, interpretability, puzzles, update-rule algorithms, language modelling, deterministic reasoning mechanisms or anything that imparts tacit knowledge in models!
